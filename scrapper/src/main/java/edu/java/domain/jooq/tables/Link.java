...
public class Link extends TableImpl<LinkRecord> {
     ...
     */
    public final TableField<LinkRecord, OffsetDateTime> LAST_CHECKED_AT = createField(DSL.name("last_checked_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6), this, "");

    /**
     * The column <code>public.link.meta_information</code>.
     */
    public final TableField<LinkRecord, String> META_INFORMATION = createField(DSL.name("meta_information"), SQLDataType.CLOB, this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function6<? super Long, ? super String, ? super String, ? super OffsetDateTime, ? super OffsetDateTime, ? super String, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function6<? super Long, ? super String, ? super String, ? super OffsetDateTime, ? super OffsetDateTime, ? super String, ? extends U> from) {
